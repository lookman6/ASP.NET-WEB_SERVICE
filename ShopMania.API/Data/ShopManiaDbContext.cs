...
namespace ShopMania.API.Data
{
    public class ShopManiaDbContext:DbContext
    {
        public ShopManiaDbContext(DbContextOptions<ShopManiaDbContext> options):base(options)
        {
