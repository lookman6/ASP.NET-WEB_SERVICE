...
namespace ShopMania.API.Controllers
{
    ...
    public class ShoppingCartController : ControllerBase
    {
        ...
        [HttpPatch("{id:int}")]
        public async Task<ActionResult<CartItemDto>> UpdateQty(int id, CartItemUpdateQtyDto cartItemQtyUpdateDto)
        {
            try
            {
